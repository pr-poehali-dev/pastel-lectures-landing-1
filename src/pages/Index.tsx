...
// Удаляем импорт из framer-motion
import {
  Clock,
  CheckCircle2,
  BookOpen,
...
const lectures = [
  {
    ...
    duration: 45,
    image:
      "https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?q=80&w=1000",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    duration: 75,
    image:
      "https://images.unsplash.com/photo-1596495577886-d920f1fb7238?q=80&w=1000",
  },
  {
    id: 5,
    ...
    duration: 60,
    image:
      "https://images.unsplash.com/photo-1561557944-6e7860d1a7eb?q=80&w=1000",
  },
  {
    id: 6,
    ...
    duration: 50,
    image:
      "https://images.unsplash.com/photo-1603126857599-f6e157fa2fe6?q=80&w=1000",
  },
];
...
const faqItems = [
  {
    ...
    answer:
      "После оформления подписки вы получите доступ к личному кабинету, в котором будут доступны все материалы согласно выбранному плану.",
  },
  {
    question: "Можно ли скачивать материалы лекций?",
    answer:
      "Да, все материалы лекций доступны для скачивания и использования в офлайн-режиме в рамках выбранного плана подписки.",
  },
  {
    question: "Как отменить подписку?",
    answer:
      "Вы можете отменить подписку в любой момент в вашем личном кабинете. Доступ к материалам сохранится до конца оплаченного периода.",
  },
  {
    question: "Выдаете ли вы сертификаты?",
    answer:
      "Да, выдаем сертификаты по окончании курсов для подписок Стандарт и Премиум. Сертификаты доступны в электронном виде.",
  },
  {
    question: "Есть ли пробный период?",
    answer:
      "Да, мы предоставляем 7-дневный пробный период для всех новых пользователей, чтобы вы могли оценить качество наших материалов.",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-blue-50">
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-500 mb-6 font-montserrat">
            Онлайн лекции для вашего развития
          </h1>
          <p className="text-xl text-gray-600 mb-10 max-w-3xl mx-auto font-rubik">
            Погрузитесь в мир знаний с комфортом. Изучайте интересующие вас темы
            в удобное время и в своем темпе.
          </p>
          <div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white bg-opacity-70">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-10 font-montserrat text-gray-800">
            Выберите интересующую науку
          </h2>
          ...
          >
            {scienceCategories.map((category) => (
              <div
                key={category.id}
                className={`shrink-0 transform transition-all duration-200 hover:scale-105 ${selectedCategory === category.id ? "ring-2 ring-purple-500" : ""}`}
          ...
          <p className="text-center text-gray-500 italic mb-8">
            {isScrolling
              ? "Нажмите на категорию, чтобы остановить"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {lectures.map((lecture) => (
              <div
                key={lecture.id}
                className={`h-full transform transition-all duration-300 ${expandedLecture === lecture.id ? "scale-105 z-10" : "scale-100 z-1"}`}
                ...
                <Card className="overflow-hidden h-full flex flex-col cursor-pointer hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="p-5 flex-grow flex flex-col">
                    ...
                    {expandedLecture === lecture.id && (
                      <div className="mt-4 pt-4 border-t border-gray-100 opacity-100 h-auto transition-all duration-300">
                        <p className="text-gray-600 mb-3">
                          Подробное изучение темы с практическими примерами и
                          разбором сложных моментов.
                        </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white bg-opacity-70">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-6 font-montserrat text-gray-800">
            Выберите подходящий план
          </h2>
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Получите доступ к образовательному контенту на условиях, которые
            подходят именно вам
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion
            type="single"
            collapsible
            className="bg-white bg-opacity-90 rounded-lg p-6 shadow-sm"
          >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-100 to-blue-100">
        <div className="max-w-5xl mx-auto text-center">
          <div className="bg-white bg-opacity-90 rounded-2xl p-8 sm:p-12 shadow-xl transform transition-all duration-500 hover:shadow-2xl">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Присоединяйтесь к тысячам студентов, которые уже расширяют свои
              горизонты с нашими онлайн-лекциями
            </p>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-600">
              Образовательная платформа с онлайн-лекциями по различным
              дисциплинам для всех, кто стремится к знаниям.
            </p>
          </div>
          <div>
